...
var InitDemo = function () {
    ...
    // Create the graphics pipeline program
    ...
    var boxVertexbufferObjectg = gl.createBuffer();
    gl.bindBuffer(gl.ARRAY_BUFFER, boxVertexbufferObjectg);
    ...
    gl.vertexAttribPointer(
        ...
        gl.FLOAT,
        gl.FALSE,
        6 * Float32Array.BYTES_PER_ELEMENT, // size of a single vertex
